...
public enum C implements Tbl.CI{logTime,id,n;
		@Override public Class<? extends Tbl>cls(){return Tbl.class;}
		@Override public Class<? extends TL.Form>clss(){return cls();}
		@Override public String text(){return name();}
		@Override public Field f(){return Tbl.Cols.f(name(), cls());}
...
*/
	...
	static{registered.add(ObjHead.class);}public static ObjHead sttc=new ObjHead( 0,0,0,0 );
