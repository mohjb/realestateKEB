...
*/}
	...
	public static void main(String[]args)throws Exception {
		...
		App.Domain d1 =domains != null && domains.size() > 1? App.Domain.loadDomain( domains.get( 1 ) ): App.Domain.initNew(mp1);
		...
		//int tn=-1;//List<App.ObjHead>test=new LinkedList<>();
		...
		if(usrB==null){
			...
			d1.usrs.put( usrB.un(),usrB );
			App.Domain.allUsrs.put( usrB.un(),usrB );
		...
		proto=d1.findChild( "name","Proto" );//for( App.ObjHead h:d1.children.values()){ if("Proto".equals(h.propStr( "name" ))){proto=h;break;}}
		pRole=(App.Domain.Role)d1.findChild( "name","Role" );//for( App.ObjHead h:d1.children.values()){ if("Role".equals(h.propStr( "name" ))){pRole=(App.Domain.Role)h;break;}}
		protoT=proto.findChild( "name","protoT" );
		boolean protoT_newlyCreated=protoT==null;if(protoT_newlyCreated) {
			p("protoT_newlyCreated");
			(protoT = new App.ObjHead(null, d1.id, proto.id, d1.id))
				.saveNewId()
				.setProps("name", "protoT"
					, "url", "proto-T"
					, "name", "protoT"
					, "description", "//1.2 create subclass of proto for testing, protoT in d1");
		}int tn= protoT.children==null?0:protoT.children.size();
		if(tn>0)t1=protoT.children.get(0);else
			(t1 = new App.ObjHead(null, protoT.id, protoT.id, d1.id))
				.saveNewId()
				.setProps("name", "protoT.t1"
					, "url", "proto-T.t1"
					, "name", "t1"
					, "description", "//1.3 create test-instance1 subclass of proto-T , with test properties");

		if(tn>1)t2=protoT.children.get(1);else
			(t2 = new App.ObjHead(null, protoT.id, protoT.id, d1.id))
				.saveNewId()
				.setProps("name", "protoT.t2"
					, "url", "proto-T.t2"
					, "name", "t2"
					, "description", "//1.4 create test-instance2 subclass of proto-T , with test properties");

		//}if d1!=null ; else tn=protoT==null|| protoT.children==null?0:protoT.children.size();
		...
		String[]requests= {
				...
				//(role!=null?"":P1+"12"+P2+"role-20',description:'//1.5 create role with limited access ,to proto-T'" + ",name:'domain1.role.view',resource:[],member:[],operation:['view']}}" )+
			...
			"{description:'3.8 change resource',id:"+role.id+",n:'resource1',v:''}" +
			"{description:'3.9 change operation',id:"+role.id+",n:'operation1',v:''}" +
			"{description:'3.10change domain',id:"+role.id+",n:'domain',v:''}" +
			//4 test cases that are intentionally-invalid requests
			"{description:'4.1  non-existing id',id:"+(t1.id+1000)+",parent:"+t1.parent+",proto:"+t1.proto+",domain:"+t1.domain+"}" +
			"{description:'4.2  non-existing proto',id:"+t1.id+",parent:"+t1.parent+",proto:"+(t1.proto+1000)+",domain:"+t1.domain+"}" +
			"{description:'4.3  non-existing parent',id:"+t1.id+",parent:"+(t1.parent+1000)+",proto:"+t1.proto+",domain:"+t1.domain+"}" +
			"{description:'4.4  non-existing domain',id:"+t1.id+",parent:"+t1.parent+",proto:"+t1.proto+",domain:"+(t1.domain+1000)+"}" +
			"{description:'4.5  non-existing property',id:"+t1.id+",n:'non-existing',v:'notOk'}" +
			"{description:'4.6  parent same as id',id:"+t1.id+",parent:"+t1.id+",proto:"+t1.proto+",domain:"+t1.domain+"}" +
		...
		P3+"o-"+(urlCounter++)+"',description:'//2.10new prop, pre-existsing'}}" +*/
				...
				",writeObjs:[ " +
					 ...
					 "{description:'4.7  proto no access moveToProto',id:"+t1.id+",parent:"+t1.parent+",proto:0,domain:"+t1.domain+"}" +
					 "{description:'4.8  proto no access moveFromProto',id:"+t1.id+",parent:"+t1.parent+",proto:"+t1.id+",domain:"+t1.domain+"}" +
					 //TODO "{description:'4.9  proto no access moveToProto nor moveFromProto',id:"+t1.id+",parent:"+t1.parent+",proto:"+t1.proto+",domain:"+t1.domain+"}" +
					 "{description:'4.10 parent no access moveToParent',id:"+t1.id+",parent:"+proto.id+",proto:"+t1.proto+",domain:"+t1.domain+"}" +
					 "{description:'4.11 parent no access moveFromParent',id:"+t1.id+",parent:"+t2.id+",proto:"+t1.proto+",domain:"+t1.domain+"}" +
					 //TODO "{description:'4.12 parent no access moveToParent nor moveFromParent',id:"+t1.id+",parent:"+t1.parent+",proto:"+t1.proto+",domain:"+t1.domain+"}" +
					 "{description:'4.13 domain no access moveToDomain',id:"+t1.id+",parent:"+t1.parent+",proto:"+t1.proto+",domain:0}" +
					 //TODO "{description:'4.14 domain no access moveFromDomain',id:"+t1.id+",parent:"+t1.parent+",proto:"+t1.proto+",domain:"+t1.id+"}" +
					 //TODO "{description:'4.15 domain no access moveToDomain nor moveFromDomain',id:"+t1.id+",parent:"+t1.parent+",proto:"+t1.proto+",domain:"+t1.domain+"}" +
					 "{description:'4.16 no access writeObj',id:"+d1.id+",parent:"+t1.id+",proto:"+d1.proto+",domain:"+d1.domain+"}" +
					 "{description:'4.17 no access writeProperty',id:"+d1.id+",n:'test',v:'no no'}" +
					 "{description:'4.18 no access newDomain, domain same as id',id:"+t1.id+",parent:"+t1.parent+",proto:"+t1.proto+",domain:"+t1.id+"}" +
					 "{description:'4.19 property un of usr, already used',id:"+usrB.id+",n:'un',v:'usr0'}" +
					 "{description:'4.20 same value prop',id:"+t1.id+",n:'test',v:0}" +
					 "{description:'4.21 same value head: proto,parent,domain',id:"+t1.id+",parent:"+t1.parent+",proto:"+t1.proto+",domain:"+t1.domain+"}" +
		...
		P3+"o-"+(urlCounter++)+"',description:'4.11 parent no access moveFromParent'}}" +
